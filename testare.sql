...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2021 at 12:40 PM
...
INSERT INTO `filme` (`id`, `name`, `nume`, `nom`, `code`, `image`, `price`, `price_eu`, `descriere_en`, `descriere_ro`, `descriere_fr`) VALUES
...
CREATE TABLE `locuri` (
  ...
  `ora_start` datetime NOT NULL,
  `ora_finish` datetime NOT NULL
...
INSERT INTO `locuri` (`rand`, `numar`, `idc`, `id_film`, `ora_start`, `ora_finish`) VALUES
(1, 1, 1, 1, '2021-01-08 12:23:37', '2021-01-08 14:23:37');
...
INSERT INTO `tbl_cart` (`id`, `product_id`, `quantity`, `user_id`) VALUES
(39, 1, 2, 1),
(40, 8, 31, 1),
(41, 10, 1, 1),
(49, 5, 1, 10),
